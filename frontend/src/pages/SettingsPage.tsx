  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '4px 16px 16px' }}>
        <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-faint)', textTransform: 'uppercase', letterSpacing: 0.6, margin: '12px 0 8px' }}>
          {t('appearance')}
        </div>
        ...
        <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-faint)', textTransform: 'uppercase', letterSpacing: 0.6, margin: '20px 0 8px' }}>
          {t('language')}
        </div>
        <div style={{ background: 'var(--bg-card)', borderRadius: 14, border: '0.5px solid var(--border)', overflow: 'hidden' }}>
          <ToggleRow
